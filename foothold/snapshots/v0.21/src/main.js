...
const config = {
  ...
  // DOM element container: needed for the Feedback form's real <select>/<textarea> (see
  // ui.js createFeedbackOverlay) - Phaser has no native dropdown or multiline text input, and
  // faking one in canvas is far worse UX than just using real HTML form controls here. Phaser
  // keeps these synced to game coordinates (including the Scale.FIT resize) automatically.
