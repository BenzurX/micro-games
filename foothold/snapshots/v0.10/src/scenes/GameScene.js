...
export class GameScene extends Phaser.Scene {
  ...
  computeLayout() {
    ...
    if (!this.isWide) {
      ...
      const hudBottom = 254;            // bottom of the HUD block (pips + tile bar) + padding before the board
    ...
    this.legendTop = this.roundY + 122;                    // below the pips + tile bar
  ...
  buildHud() {
    ...
    this.buildRoundTimeline(railX, railW, this.roundY + 66);
