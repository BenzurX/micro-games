  ...
  play(name, opts = {}) {
    ...
    switch (name) {
      ...
      case 'tideHigh': { // nautical two-strike ship's bell announcing high tide taking the
        ...
        this.tone({ freq: base, dur: 1.4, type: 'sine', gain: 0.13, delay: 0.62, attack: 0.015 });
        this.tone({ freq: base * 2.42, dur: 0.9, type: 'sine', gain: 0.07, delay: 0.62, attack: 0.015 });
        this.tone({ freq: base, dur: 1.6, type: 'sine', gain: 0.06, delay: 1.05, attack: 0.02 });
        break;
      }
